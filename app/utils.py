...
def generate_timeline(id):
    ...
    timeline = [
        ...
        {'title': 'First Interview', 'date': history.interview_round_1, 'comments': history.interview_round_1_comments} if history.interview_round_1 else None,
        {'title': 'Second Interview', 'date': history.interview_round_2, 'comments': history.interview_round_2_comments} if history.interview_round_2 else None,
        {'title': 'HR Interview', 'date': history.hr_round, 'comments': history.hr_round_comments} if history.hr_round else None,
        {'title': 'Rejected'} if history.rejected else None,
        {'title': 'Onboarding'} if history.interview_round_2 and not history.rejected else None
    ]
